...
export async function getMemberSteamIdAll():Promise<MemberInfo[]> {
  ...
  members.push(new MemberInfo(967052298));
  members.push(new MemberInfo(1159610111));
  // 永久会员
  ...
  members.push(new MemberInfo(141315077, new Date("2022-10-05T00:00:00")));
  ...
  members.push(new MemberInfo(444831658, new Date("2022-12-07T00:00:00")));
  ...
  members.push(new MemberInfo(215738002, new Date("2022-10-03T00:00:00")));
  ...
  members.push(new MemberInfo(115909929, new Date("2023-03-17T00:00:00")));
  members.push(new MemberInfo(323139801, new Date("2022-09-13T00:00:00")));
  members.push(new MemberInfo(322229870, new Date("2022-10-14T00:00:00")));
  ...
  members.push(new MemberInfo(132588126, new Date("2022-12-01T00:00:00")));
  members.push(new MemberInfo(186715813, new Date("2022-09-30T00:00:00")));
  members.push(new MemberInfo(1037402422, new Date("2022-09-30T00:00:00")));
  members.push(new MemberInfo(160996305, new Date("2022-09-30T00:00:00")));
  members.push(new MemberInfo(342049002, new Date("2022-10-02T00:00:00")));
  members.push(new MemberInfo(59388035, new Date("2022-12-02T00:00:00")));
  members.push(new MemberInfo(1030644778, new Date("2022-10-04T00:00:00")));
  members.push(new MemberInfo(139467272, new Date("2022-10-04T00:00:00")));
  members.push(new MemberInfo(225169923, new Date("2022-10-04T00:00:00")));
  members.push(new MemberInfo(355022199, new Date("2022-10-04T00:00:00")));
  members.push(new MemberInfo(233537853, new Date("2022-12-07T00:00:00")));
  members.push(new MemberInfo(136559231, new Date("2022-10-07T00:00:00")));
  members.push(new MemberInfo(109567838, new Date("2022-10-07T00:00:00")));
  members.push(new MemberInfo(134020001, new Date("2023-09-19T00:00:00")));
  members.push(new MemberInfo(231445049, new Date("2023-09-14T00:00:00")));
  members.push(new MemberInfo(177921837, new Date("2022-10-07T00:00:00")));
  members.push(new MemberInfo(171842580, new Date("2022-10-08T00:00:00")));
  members.push(new MemberInfo(329920068, new Date("2022-10-09T00:00:00")));
  members.push(new MemberInfo(422435396, new Date("2022-10-10T00:00:00")));
  ...
  members.push(new MemberInfo(487120656, new Date("2022-10-12T00:00:00")));
  members.push(new MemberInfo(310735421, new Date("2023-09-18T00:00:00")));
  members.push(new MemberInfo(139693013, new Date("2022-12-13T00:00:00")));
  members.push(new MemberInfo(139345058, new Date("2022-12-13T00:00:00")));
  members.push(new MemberInfo(153632407, new Date("2023-12-06T00:00:00")));
  members.push(new MemberInfo(908271686, new Date("2023-09-11T00:00:00")));
  members.push(new MemberInfo(932992019, new Date("2022-10-12T00:00:00")));
  members.push(new MemberInfo(147443347, new Date("2022-10-12T00:00:00")));
  members.push(new MemberInfo(112073229, new Date("2023-03-17T00:00:00")));
  members.push(new MemberInfo(127562876, new Date("2022-10-12T00:00:00")));
  members.push(new MemberInfo(180087758, new Date("2022-10-12T00:00:00")));
  members.push(new MemberInfo(219219483, new Date("2022-12-13T00:00:00")));
  members.push(new MemberInfo(140880944, new Date("2022-10-12T00:00:00")));
  members.push(new MemberInfo(1034344949, new Date("2022-10-12T00:00:00")));
  members.push(new MemberInfo(356899063, new Date("2022-10-12T00:00:00")));
  members.push(new MemberInfo(837505882, new Date("2023-03-16T00:00:00")));
  members.push(new MemberInfo(167246975, new Date("2022-10-13T00:00:00")));
  // patreon
