...
export async function getMemberSteamIdAll():Promise<MemberInfo[]> {
  ...
  members.push(new MemberInfo(121577760, new Date("2023-09-20T00:00:00")));
  members.push(new MemberInfo(139073897, new Date("2023-09-21T00:00:00")));
  members.push(new MemberInfo(317958553, new Date("2023-09-21T00:00:00")));
  members.push(new MemberInfo(245559423, new Date("2023-09-21T00:00:00")));
  // patreon
...
export function initMemberSteamId():void {
  ...
  members.push(new Member(121577760, new Date("2023-09-20T00:00:00")));
  members.push(new Member(139073897, new Date("2023-09-21T00:00:00")));
  members.push(new Member(317958553, new Date("2023-09-21T00:00:00")));
  members.push(new Member(245559423, new Date("2023-09-21T00:00:00")));
  // patreon
