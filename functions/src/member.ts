...
export async function getMemberSteamIdAll():Promise<MemberInfo[]> {
  ...
  members.push(new MemberInfo(153632407, new Date("2022-09-06T00:00:00")));
  ...
  members.push(new MemberInfo(109270703, new Date("2022-08-07T00:00:00")));
  members.push(new MemberInfo(78534313, new Date("2022-08-07T00:00:00")));
  members.push(new MemberInfo(292827485, new Date("2022-08-09T00:00:00")));
  ...
  members.push(new MemberInfo(138189607, new Date("2022-08-17T00:00:00")));
  ...
  members.push(new MemberInfo(86539525, new Date("2022-09-01T00:00:00")));
  // 测试
...
export function initMemberSteamId():void {
  ...
  members.push(new Member(153632407, new Date("2022-09-06T00:00:00")));
  ...
  members.push(new Member(109270703, new Date("2022-08-07T00:00:00")));
  members.push(new Member(78534313, new Date("2022-08-07T00:00:00")));
  members.push(new Member(292827485, new Date("2022-08-09T00:00:00")));
  ...
  members.push(new Member(138189607, new Date("2022-08-17T00:00:00")));
  ...
  members.push(new Member(86539525, new Date("2022-09-01T00:00:00")));
  // 测试
